...
QT_MOC_LITERAL(1, 10, 8), // "sendImgs"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 19), // "std::vector<QImage>"
QT_MOC_LITERAL(4, 40, 4), // "imgs"
QT_MOC_LITERAL(5, 45, 6), // "startP"
QT_MOC_LITERAL(6, 52, 4), // "endP"
QT_MOC_LITERAL(7, 57, 8), // "identify"
QT_MOC_LITERAL(8, 66, 6) // "METHOD"

    },
    "cv_worker\0sendImgs\0\0std::vector<QImage>\0"
    "imgs\0startP\0endP\0identify\0METHOD"
};
...
void cv_worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendImgs((*reinterpret_cast< std::vector<QImage>(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->identify((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (cv_worker::*)(std::vector<QImage> , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cv_worker::sendImgs)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void cv_worker::sendImgs(std::vector<QImage> _t1, int _t2, int _t3)
{
