...
public:
    ...
    QLabel *label_OverAll_nQuestions;
    QSpinBox *spinBox_OverAll_nQuestions;
    QGroupBox *groupBox_Info_CurrentPage;
    QSpinBox *spinbox_CurrentPage_nQuestions;
    QLabel *label_CurrentPage_nQuestions;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_OverAll_nQuestions = new QLabel(groupBox_Info_Overall);
        label_OverAll_nQuestions->setObjectName(QStringLiteral("label_OverAll_nQuestions"));
        label_OverAll_nQuestions->setGeometry(QRect(10, 20, 111, 16));
        spinBox_OverAll_nQuestions = new QSpinBox(groupBox_Info_Overall);
        spinBox_OverAll_nQuestions->setObjectName(QStringLiteral("spinBox_OverAll_nQuestions"));
        spinBox_OverAll_nQuestions->setGeometry(QRect(130, 20, 43, 22));
        spinBox_OverAll_nQuestions->setAlignment(Qt::AlignCenter);
        spinBox_OverAll_nQuestions->setAccelerated(true);
        spinBox_OverAll_nQuestions->setMinimum(0);
        spinBox_OverAll_nQuestions->setMaximum(10000);
        spinBox_OverAll_nQuestions->setValue(0);
        ...
        spinbox_CurrentPage_nQuestions = new QSpinBox(groupBox_Info_CurrentPage);
        spinbox_CurrentPage_nQuestions->setObjectName(QStringLiteral("spinbox_CurrentPage_nQuestions"));
        spinbox_CurrentPage_nQuestions->setGeometry(QRect(130, 20, 43, 22));
        spinbox_CurrentPage_nQuestions->setAlignment(Qt::AlignCenter);
        spinbox_CurrentPage_nQuestions->setButtonSymbols(QAbstractSpinBox::PlusMinus);
        spinbox_CurrentPage_nQuestions->setAccelerated(true);
        spinbox_CurrentPage_nQuestions->setMinimum(0);
        spinbox_CurrentPage_nQuestions->setMaximum(10000);
        spinbox_CurrentPage_nQuestions->setValue(0);
        label_CurrentPage_nQuestions = new QLabel(groupBox_Info_CurrentPage);
        label_CurrentPage_nQuestions->setObjectName(QStringLiteral("label_CurrentPage_nQuestions"));
        label_CurrentPage_nQuestions->setGeometry(QRect(10, 20, 111, 21));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_OverAll_nQuestions->setText(QApplication::translate("MainWindow", "Number of Questions: ", nullptr));
        groupBox_Info_CurrentPage->setTitle(QApplication::translate("MainWindow", "Current Page:", nullptr));
        label_CurrentPage_nQuestions->setText(QApplication::translate("MainWindow", "Number of Questions:", nullptr));
